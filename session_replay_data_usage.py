...
class AdbCommands:
    ...
    def configure(self):
        ...
        AdbCommands.checked_subprocess_call(
            'adb shell am force-stop {} && adb shell "am start -W -a android.intent.action.VIEW -d cs-{}://contentsquare.com?activationKey=weballwin\&userId=iamjenkins\&configure="SESSION_REPLAY_FORCE_START=true,VERBOSE_LOG=true""'.format(
